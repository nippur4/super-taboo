...
const FICHAS = [
  ...
  { letra: 'E', bg: '#3E7BFF', color: '#FAF4E8', rot: 4 },
  { letra: 'C', bg: '#FFC93C', color: '#201233', rot: -3 },
  { letra: 'I', bg: '#9B5DE5', color: '#FAF4E8', rot: 5 },
  { letra: 'R', bg: '#00C489', color: '#FAF4E8', rot: -4 },
  { letra: 'L', bg: '#FF4E45', color: '#FAF4E8', rot: 3 },
  { letra: 'O', bg: '#3E7BFF', color: '#FAF4E8', rot: -5 },
];
  ...
  return (
    <div className="screen home">
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 10 }}>
        <div className="home-super">DECILO SIN</div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div className="mode-card" onClick={() => onElegir('clasico')}>
          <div className="titulo">CLÁSICO</div>
          <div className="desc">El de siempre: hacé adivinar la palabra sin decir las prohibidas.</div>
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            <span className="mode-pill" style={{ background: '#FF4E45' }}>PALABRAS PROHIBIDAS</span>
          </div>
        </div>

        <div className="mode-card" onClick={() => onElegir('super')}>
          <div className="titulo">SUPER DECILO</div>
        ...
        <div className="mode-card dark" onClick={() => onElegir('extremo')}>
          <div className="titulo">DECILO EXTREMO</div>
